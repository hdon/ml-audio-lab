...
w2 = tf.Variable(tf.truncated_normal([num_hidden, num_hidden]))
w3 = tf.Variable(tf.truncated_normal([num_hidden, num_features]))
b1 = tf.Variable(tf.truncated_normal([num_hidden]))
b2 = tf.Variable(tf.truncated_normal([num_hidden]))
b3 = tf.Variable(tf.truncated_normal([num_features]))
